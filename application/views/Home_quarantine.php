...
<div class="col-sm-12">
   <h1 class="text-center" >Admin Panel For Home Quarantine</h1>
</div>

   
   <br>
   
   <a class="a_color" href="<?php echo base_url(); ?>index.php/TakeHomeAttendance"><button type="button" class="btn btn-primary btn-lg">Take Attendance</button></a>
